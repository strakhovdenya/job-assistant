...
- [x] Добавить поддержку `skills` в Job:
  - [x] хранение list[str]
  - [x] обновление через PATCH
...
- [x] можно открыть RawJob  
- [x] можно создать Job  
- [x] можно заполнить title и company  
- [x] можно добавить skills  
- [x] можно сохранить Job  
- [x] Job отображается в списке  
- [x] RawJob остаётся неизменным  
